  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-end pb-7 gap-3">
        ...
        <AnimatePresence mode="wait">
          <motion.span
            ...
            className="text-white text-sm font-semibold tracking-wide px-3 py-1 rounded-full bg-black/20 backdrop-blur-sm"
          >
            {SLIDES[current].alt}
          </motion.span>
        </AnimatePresence>
      ...
      <button
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-9 h-9 rounded-full bg-white/80 backdrop-blur-sm shadow flex items-center justify-center text-slate-700 hover:bg-white transition-colors"
      ...
      <button
        onClick={next}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-9 h-9 rounded-full bg-white/80 backdrop-blur-sm shadow flex items-center justify-center text-slate-700 hover:bg-white transition-colors"

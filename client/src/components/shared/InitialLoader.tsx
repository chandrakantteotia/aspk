    ...
    <AnimatePresence>
      {loading && (
        ...
        >
          ...
          <div className="absolute w-[80vw] h-[80vw] max-w-[600px] max-h-[600px] rounded-full bg-[var(--color-primary)]/30 blur-[100px] pointer-events-none" />
          ...
          <div className="relative z-10 flex flex-col items-center px-4 text-center">
            ...
            <motion.div
              ...
              className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-white/10 border border-white/20 -xl flex items-center justify-center p-3 shadow-xl mb-5"
            >
              <img
                src={footerLogo}
                alt="ASPK4Hapur Logo"

  ...
  return (
    <main className="w-full bg-slate-50 min-h-screen text-slate-900 overflow-x-hidden">
        ...
        <div className="container-padded relative z-10">
          <div className="grid lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
              ...
              >
                Building a Transparent & Digitally Empowered <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0004A3] via-blue-700 to-blue-900">Hapur</span>
              </motion.h1>
              ...
              >
                <Link
                  to="/join"
                  className="px-6 sm:px-7 py-3.5 rounded-full bg-[#0004A3] hover:bg-blue-900 text-white font-bold text-sm shadow-[0_4px_20px_rgba(0,4,163,0.3)] transition-all flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95"
                >
                ...
                >
                  <FileText className="w-4 h-4 text-[#0004A3]" />
            ...
            <div className="lg:col-span-5 relative">
              <motion.div
                ...
                className="relative mx-auto max-w-md lg:max-w-none rounded-2xl sm:rounded-3xl overflow-hidden p-2 sm:p-2.5 bg-slate-100 border border-slate-200 shadow-xl"
              >
                <img
                  src={heroDesktopImg}
                  alt="ASPK4Hapur Leadership & Community Rallies"
                  className="w-full h-64 sm:h-88 lg:h-96 object-cover rounded-xl sm:rounded-2xl filter brightness-105 contrast-105"
                />

                {/* Floating Badge overlay */}
                <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-slate-900/90 backdrop-blur-md border border-slate-800 text-white flex items-center justify-between shadow-lg">
                  <div className="flex items-center gap-2.5 sm:gap-3">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-[#0004A3] flex items-center justify-center text-yellow-300 shrink-0">
      ...
      <section className="relative z-20 -mt-8 sm:-mt-10 container-padded">
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-slate-200/80 p-5 sm:p-8 lg:p-10 grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 divide-y sm:divide-y-0 sm:divide-x divide-slate-100">
          
          <div className="flex flex-col items-center text-center p-2">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-blue-50 text-[#0004A3] flex items-center justify-center mb-2 sm:mb-3">
              <Building2 className="w-5 h-5 sm:w-6 sm:h-6" />
            </div>
            <div className="text-2xl sm:text-4xl lg:text-5xl font-black font-display text-slate-900 tracking-tight">
              {districtCount}+
            </div>
          ...
          <div className="flex flex-col items-center text-center p-2 pt-4 sm:pt-2">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-amber-50 text-amber-600 flex items-center justify-center mb-2 sm:mb-3">
          ...
          <div className="flex flex-col items-center text-center p-2 pt-4 lg:pt-2">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center mb-2 sm:mb-3">
          ...
          <div className="flex flex-col items-center text-center p-2 pt-4 lg:pt-2">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-purple-50 text-purple-600 flex items-center justify-center mb-2 sm:mb-3">
      ...
      <section className="container-padded py-16 sm:py-24 lg:py-28">
        <div className="text-center max-w-3xl mx-auto space-y-3 sm:space-y-4 mb-12 sm:mb-16">
          <span className="text-[#0004A3] font-extrabold tracking-widest uppercase text-xs bg-blue-50 px-4 py-1.5 rounded-full inline-block">
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative bg-white p-6 sm:p-10 rounded-2xl sm:rounded-3xl border border-slate-200/90 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between overflow-hidden"
          >
            ...
            <div className="space-y-5 sm:space-y-6 relative z-10">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-[#0004A3] text-white flex items-center justify-center shadow-md">
                  <Target className="w-6 h-6 sm:w-7 sm:h-7" />
                </div>
                <span className="text-4xl sm:text-5xl font-black font-display text-slate-200 group-hover:text-[#0004A3]/20 transition-colors">
                  01
                </span>
              </div>
          ...
          >
            ...
            <div className="space-y-5 sm:space-y-6 relative z-10">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-amber-400 text-slate-950 flex items-center justify-center shadow-md">
                  <Eye className="w-6 h-6 sm:w-7 sm:h-7" />
                </div>
                <span className="text-4xl sm:text-5xl font-black font-display text-slate-200 group-hover:text-amber-500/20 transition-colors">
                  02
                </span>
              </div>
      ...
      <section className="bg-gradient-to-r from-slate-900 via-[#0004A3] to-slate-900 text-white py-16 sm:py-20 lg:py-24 relative overflow-hidden">
        <div className="container-padded relative z-10 max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
          <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white/10 backdrop-blur border border-white/20 flex items-center justify-center mx-auto text-yellow-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {values.map((val, idx) => (
            <motion.div
              ...
              className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between"
            >
              <div className="space-y-4 sm:space-y-5">
                <div className="flex items-center justify-between">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-blue-50 text-[#0004A3] flex items-center justify-center">
      ...
      <section className="container-padded py-16 sm:py-24 lg:py-28 bg-white border-t border-slate-200/60">
        ...
        <div ref={timelineRef} className="max-w-4xl mx-auto relative pl-4 sm:pl-0 space-y-8 sm:space-y-12">
          ...
          <div className="hidden sm:block absolute left-1/2 top-4 bottom-4 w-1 bg-gradient-to-b from-[#0004A3] via-blue-300 to-amber-400 -translate-x-1/2 rounded-full" />
            ...
            return (
              ...
              >
                ...
                <div className="w-full sm:w-[45%] pl-6 sm:pl-0">
                  <div className="bg-slate-50 border border-slate-200/90 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-sm hover:shadow-md transition-shadow relative">
                    <div className="flex items-center justify-between mb-2.5">
                      <span className="text-2xl sm:text-3xl font-black font-display text-[#0004A3]">{ms.year}</span>
                      <span className="text-[10px] sm:text-[10.5px] font-bold uppercase tracking-wider bg-blue-100 text-[#0004A3] px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full">
                        {ms.tag}
                      </span>
                    </div>
                ...
                <div className="hidden sm:flex z-10 w-10 h-10 rounded-full bg-[#0004A3] text-yellow-300 items-center justify-center border-4 border-white shadow-md shrink-0">
      ...
      <section className="container-padded py-12 sm:py-20 lg:py-24">
        <div className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-r from-[#0004A3] via-blue-900 to-slate-950 text-white p-6 sm:p-12 lg:p-16 overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center space-y-4 sm:space-y-6">
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-display font-black text-white tracking-tight leading-tight">
            ...
            <div className="pt-2 sm:pt-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4">
              <Link
                to="/join"
                className="px-7 sm:px-8 py-3.5 sm:py-4 rounded-full bg-yellow-400 hover:bg-yellow-300 text-[#0004A3] font-bold text-sm shadow-xl transition-all flex items-center justify-center gap-2 hover:scale-[1.03] active:scale-95"
              >
              ...
              <Link
                to="/contact"
                className="px-7 sm:px-8 py-3.5 sm:py-4 rounded-full bg-white/10 hover:bg-white/20 text-white border border-white/20 font-semibold text-sm backdrop-blur-md transition-all flex items-center justify-center gap-2"
              >
